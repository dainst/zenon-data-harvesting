            ...
            for article in articles:
                if int(article.find('a').text.replace('.', '')) > last_item_harvested_in_last_session:
                    ...
                    try:
                        ...
                        publication_dict['host_item'] = {'name': 'Bryn Mawr Classical Review', 'sysnumber': '000810352'}
